...
interface BlaseballDatabaseOffseasonSetupEndpoint : BlaseballEndpoint {
    ...
    object Live : BlaseballDatabaseOffseasonSetupEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            league.httpClient.get("https://www.blaseball.com/database/offseasonSetup")

        override fun describe(): JsonElement? =
            JsonPrimitive("live")
    }

    data class Static(val data: JsonElement?): BlaseballDatabaseOffseasonSetupEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            data
    ...
    companion object {
        infix fun loadFrom(config: JsonElement?): KorneaResult<BlaseballDatabaseOffseasonSetupEndpoint?> {
