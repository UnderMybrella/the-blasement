...
interface BlaseballDatabaseSunSunEndpoint : BlaseballEndpoint {
    ...
    object Live : BlaseballDatabaseSunSunEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            league.httpClient.get("https://www.blaseball.com/database/sunsun")

        override fun describe(): JsonElement? =
            JsonPrimitive("live")
    }

    data class Static(val data: JsonElement?): BlaseballDatabaseSunSunEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            data
    ...
    companion object {
        infix fun loadFrom(config: JsonElement?): KorneaResult<BlaseballDatabaseSunSunEndpoint?> {
