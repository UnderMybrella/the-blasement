...
interface BlaseballApiGetRisingStarsEndpoint : BlaseballEndpoint {
    ...
    object Live: BlaseballApiGetRisingStarsEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            league.httpClient.get("https://www.blaseball.com/api/getRisingStars")

        override fun describe(): JsonElement =
            JsonPrimitive("live")
    }

    data class Static(val data: JsonElement?): BlaseballApiGetRisingStarsEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            data
    ...
    companion object {
        infix fun loadFrom(config: JsonElement?): KorneaResult<BlaseballApiGetRisingStarsEndpoint?> {
