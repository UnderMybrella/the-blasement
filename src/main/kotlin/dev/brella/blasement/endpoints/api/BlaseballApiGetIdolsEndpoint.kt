...
interface BlaseballApiGetIdolsEndpoint : BlaseballEndpoint {
    ...
    object Live: BlaseballApiGetIdolsEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            league.httpClient.get("https://www.blaseball.com/api/getIdols")

        override fun describe(): JsonElement =
            JsonPrimitive("live")
    }

    data class Static(val data: JsonElement?): BlaseballApiGetIdolsEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            data
    ...
    companion object {
        infix fun loadFrom(config: JsonElement?): KorneaResult<BlaseballApiGetIdolsEndpoint?> {
