...
interface BlaseballApiGetTributesEndpoint : BlaseballEndpoint {
    ...
    object Live : BlaseballApiGetTributesEndpoint {
        override suspend fun getDataFor(league: BlasementLeague, request: Request): JsonElement? =
            league.httpClient.get("https://www.blaseball.com/api/getTribute")
    ...
    companion object {
        infix fun loadFrom(config: JsonElement?): KorneaResult<BlaseballApiGetTributesEndpoint?> {
